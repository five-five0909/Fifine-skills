---
name: skills-research-deep-read
description: Use this skill when the user wants a structured paper-reading pipeline driven from a PDF, especially to produce staged outputs for abstract, introduction, related work, method, formulas, and experiments. Trigger: /skills-research-deep-read, read paper, 论文阅读, structured reading, abstract introduction.
---

# skills-research-deep-read

## Trigger check
This skill applies when the user wants a structured multi-stage reading pipeline for a research paper PDF. If the user only wants a quick summary — stop, use skills-research-quick-read instead.
...
- `@skills-research-deep-read <pdf路径>`
- `@skills-research-deep-read <pdf路径> 帮我精读`
- `@skills-research-deep-read <pdf路径> 全部生成`
- `@skills-research-deep-read <pdf路径> 只看实验`
- `@skills-research-deep-read <pdf路径> 只看公式`
- `@skills-research-deep-read <pdf路径> 只看摘要和实验`
...
- 旧逻辑已经被整合为 `skills-research-deep-read` 内部阶段。
