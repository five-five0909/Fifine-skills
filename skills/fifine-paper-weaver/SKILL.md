---
name: fifine-paper-weaver
description: Use this skill when the user wants a structured paper-reading pipeline driven from a PDF, especially to produce staged outputs for abstract, introduction, related work, method, formulas, and experiments. Trigger: /fifine-paper-weaver, read paper, 论文阅读, structured reading, abstract introduction.
---

# fifine-paper-weaver

## Trigger check
This skill applies when the user wants a structured multi-stage reading pipeline for a research paper PDF. If the user only wants a quick summary — stop, use fifine-lit-speed-read instead.
...
- `@fifine-paper-weaver <pdf路径>`
- `@fifine-paper-weaver <pdf路径> 帮我精读`
- `@fifine-paper-weaver <pdf路径> 全部生成`
- `@fifine-paper-weaver <pdf路径> 只看实验`
- `@fifine-paper-weaver <pdf路径> 只看公式`
- `@fifine-paper-weaver <pdf路径> 只看摘要和实验`
...
- 旧逻辑已经被整合为 `fifine-paper-weaver` 内部阶段。
