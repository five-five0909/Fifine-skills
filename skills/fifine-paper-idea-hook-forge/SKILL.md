...
## Trigger check
This skill applies when the user has a research paper PDF and wants to extract its structure, hooks, and idea components. If no PDF is provided or the user only wants a quick summary — stop, use fifine-lit-speed-read instead.
...
- 如果用户只想做传统论文分章阅读，应该走 `fifine-paper-weaver`。
