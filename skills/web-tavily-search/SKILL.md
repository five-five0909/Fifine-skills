---
name: web-tavily-search
description: Use this skill when the user asks for current information, recent updates, documentation lookup, or fact verification, especially when a live web search is required instead of relying on stale model memory. Trigger: /web-tavily-search, search web, 联网搜索, current info, live search.
---
