---
name: writing-prompt-amplifier
description: Use this skill when the user wants an instruction rewritten into a stronger execution prompt before handing it to another model or workflow, especially when adherence and precision matter. Trigger: /writing-prompt-amplifier, amplify prompt, 强化指令, rewrite instruction.
---
