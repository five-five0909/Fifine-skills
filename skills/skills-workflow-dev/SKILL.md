...
- `@skills-workflow-dev 我想做 <任务描述>`
- `@skills-workflow-dev 有个 bug: <症状描述>`
- `@skills-workflow-dev 需要重构 <目标模块>`
