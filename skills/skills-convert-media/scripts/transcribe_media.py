...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default=None, help="Output directory. Default: ./skills-convert-media-output/<name>-<timestamp>")
...
def main() -> int:
    ...
    output_dir = Path(args.output_dir) if args.output_dir else Path.cwd() / "skills-convert-media-output" / f"{safe_stem(media_path)}-{timestamp}"
