---
name: academic-idea-hook-forge
description: Use this skill when the user wants to decompose a research paper PDF into structured components, extract hooks, and generate idea, experiment, and writing artifacts with an HTML report as the main output. Trigger: /academic-idea-hook-forge, paper PDF, extract hook, 论文拆解, idea extraction.
---
...
## 用户入口
- `@academic-idea-hook-forge <pdf路径>`
- `@academic-idea-hook-forge <pdf路径> 全流程`
- `@academic-idea-hook-forge <pdf路径> 只提取 hook`
- `@academic-idea-hook-forge <pdf路径> 只做分类`
- `@academic-idea-hook-forge <pdf路径> 生成 HTML 报告`
