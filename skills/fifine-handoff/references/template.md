...
- `<skill-name>` — <why for this goal>
- `None identified.` — use this exact entry if no available skill is relevant
...
- <Only commands valid in the receiver's harness. Omit this whole section unless your overlay names a relevant project/session tool.>
```
