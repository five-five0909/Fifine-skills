...
把 skills-writing-research-paper 当作研究对象。
检查 SKILL.md、references/、scripts/、templates/、examples/ 和 README。
生成 paper_story.md、claim_evidence_map.md、文献定位、已核验引用、ICML 风格图表，并在 examples/paper-about-skills-writing-research-paper/paper/ 下生成可编译的 ICML LaTeX 论文。
不要编造性能数字，只使用仓库中可以检查的事实作为证据。
```

这个 example 已经包含完整输出。想快速判断生成质量，可以直接看 PDF：

- **生成的 ICML 风格论文：** [`paper/main.pdf`](examples/paper-about-skills-writing-research-paper/paper/main.pdf)
...
- [`evaluation/auto_research_handoff_results.json`](examples/paper-about-skills-writing-research-paper/evaluation/auto_research_handoff_results.json)：auto-research 真实 CLI 到本 skill validator 的跨仓库兼容性结果。
...
```text
请把 https://github.com/jin-s13/skills-writing-research-paper 安装成本地 skill。
...
| [`examples/paper-about-skills-writing-research-paper/`](examples/paper-about-skills-writing-research-paper/) | 用本项目给自己写论文的端到端示例 |
