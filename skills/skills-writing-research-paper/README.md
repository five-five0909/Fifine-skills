...
![AI Research Writing Skill teaser](examples/paper-about-skills-writing-research-paper/paper/figures/teaser_imagegen.png)
...
Create paper_story.md, claim_evidence_map.md, literature positioning, verified citations, ICML-style method figures/tables, and a build-ready ICML LaTeX paper under examples/paper-about-skills-writing-research-paper/paper/.
...
- **Read the generated ICML-style paper PDF:** [`paper/main.pdf`](examples/paper-about-skills-writing-research-paper/paper/main.pdf)
...
- [`evaluation/auto_research_handoff_results.json`](examples/paper-about-skills-writing-research-paper/evaluation/auto_research_handoff_results.json): real CLI-to-validator compatibility result between auto-research and this skill.

![AI Research Writing Skill method overview](examples/paper-about-skills-writing-research-paper/paper/figures/overview_imagegen.png)
...
```text
Install https://github.com/jin-s13/skills-writing-research-paper as a local skill.
...
```bash
git clone https://github.com/jin-s13/skills-writing-research-paper.git
...
| [`examples/paper-about-skills-writing-research-paper/`](examples/paper-about-skills-writing-research-paper/) | End-to-end paper about this project |
