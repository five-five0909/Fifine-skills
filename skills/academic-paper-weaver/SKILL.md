---
name: academic-paper-weaver
description: Use this skill when the user wants a structured paper-reading pipeline driven from a PDF, especially to produce staged outputs for abstract, introduction, related work, method, formulas, and experiments. Trigger: /academic-paper-weaver, read paper, 论文阅读, structured reading, abstract introduction.
---
...
- `@academic-paper-weaver <pdf路径>`
- `@academic-paper-weaver <pdf路径> 帮我精读`
- `@academic-paper-weaver <pdf路径> 全部生成`
- `@academic-paper-weaver <pdf路径> 只看实验`
- `@academic-paper-weaver <pdf路径> 只看公式`
- `@academic-paper-weaver <pdf路径> 只看摘要和实验`
