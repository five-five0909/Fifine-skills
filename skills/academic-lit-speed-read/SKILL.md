---
name: academic-lit-speed-read
description: Use this skill when the user needs a fast but structured reading workflow for a paper, URL, PDF, or HTML source, especially to summarize the core claim and generate a report for academic review. Trigger: /academic-lit-speed-read, speed read, 速读, paper summary, 文献摘要.
---
