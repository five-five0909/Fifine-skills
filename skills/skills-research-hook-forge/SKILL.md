---
name: skills-research-hook-forge
description: Use this skill when the user wants to decompose a research paper PDF into structured components, extract hooks, and generate idea, experiment, and writing artifacts with an HTML report as the main output. Trigger: /skills-research-hook-forge, paper PDF, extract hook, 论文拆解, idea extraction.
---

# idea-hook-forge

## Trigger check
This skill applies when the user has a research paper PDF and wants to extract its structure, hooks, and idea components. If no PDF is provided or the user only wants a quick summary — stop, use skills-research-quick-read instead.
...
## 用户入口
- `@skills-research-hook-forge <pdf路径>`
- `@skills-research-hook-forge <pdf路径> 全流程`
- `@skills-research-hook-forge <pdf路径> 只提取 hook`
- `@skills-research-hook-forge <pdf路径> 只做分类`
- `@skills-research-hook-forge <pdf路径> 生成 HTML 报告`
...
- 如果用户只想做传统论文分章阅读，应该走 `skills-research-deep-read`。
