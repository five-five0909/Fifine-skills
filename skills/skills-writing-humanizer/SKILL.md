...
Based on [`skills-writing-humanizer`](https://github.com/dongshuyan/compass-skills/tree/master/skills/skills-writing-humanizer) from COMPASS Skills (MIT). The bundled `LICENSE` preserves the upstream notice.
