...
- `writing-style`: Use this skill when the user wants to write, rewrite, adapt, or polish text through a selectable writing role, reusable personal style, or platform-specific voice.
